    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <section className="hero-section relative min-h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        >
          {heroImages.map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`Desert to Mountains Hero Slide ${
                index + 1
              ...
              style={{
                ...
                willChange:
                  index === currentSlide ? "opacity, transform" : "auto",
              }}
        ...
        <div className="relative z-20 flex flex-col items-center justify-center w-full px-2 sm:px-4">
          <div
            className="backdrop-blur-xl bg-white/20 border border-white/30 rounded-2xl sm:rounded-3xl shadow-2xl px-3 py-6 sm:px-8 sm:py-16 md:px-20 md:py-24 max-w-[95vw] sm:max-w-xl md:max-w-2xl mx-auto flex flex-col items-center animate-panel-float"
            style={{ boxShadow: "0 8px 48px 0 rgba(90, 80, 30, 0.18)" }}
          >
        ...
        <style jsx global>{`
          ...
          @keyframes letter-reveal {
            0% {
              opacity: 0;
              transform: translateY(30px) scale(0.9) skewY(8deg);
              filter: blur(4px);
            }
            60% {
              opacity: 1;
              transform: translateY(-4px) scale(1.04) skewY(-2deg);
              filter: blur(0.5px);
            }
            100% {
              opacity: 1;
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <div className="text-center mb-8">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#5E4E06] leading-tight tracking-tight">
                Desert to Mountains
              </h1>
            </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="space-y-8">
                <p className="text-xl md:text-2xl text-[#2A2418]/80 leading-relaxed font-light">
                  Desert to Mountains is a vision born from the raw beauty and
                  wisdom of India's landscapes—from the sun-baked dunes of the
                  Thar Desert to the enduring serenity of the Himalayan ranges.
                  Our mission is rooted in a single belief:{" "}
                  <span className="font-semibold text-[#5E4E06]">
                    nature has everything we need
                  </span>
                  , if only we learn how to use it responsibly.
                </p>

                <p className="text-lg md:text-xl text-[#2A2418]/70 leading-relaxed">
                  We are dedicated to reviving ancient building practices
                  through modern, sustainable innovation. By crafting
                  eco-conscious materials that honor our ecological heritage, we
                  aim to redefine how homes and buildings interact with the
                  environment.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            <div className="group p-8 bg-gradient-to-br from-[#F8F6F0] to-[#F0EDE4] rounded-3xl border border-[#E8E4D8] hover:shadow-2xl transition-all duration-500 hover:scale-105">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-black text-[#2A2418]">
                  Minimally Processed
                </h3>
              </div>
              <p className="text-[#2A2418]/70 text-lg leading-relaxed">
                Each of our products is developed with care—minimally processed,
                naturally sourced, and designed to nourish not just your spaces,
            ...
            <div className="group p-8 bg-gradient-to-br from-[#F8F6F0] to-[#F0EDE4] rounded-3xl border border-[#E8E4D8] hover:shadow-2xl transition-all duration-500 hover:scale-105">
              ...
              <p className="text-[#2A2418]/70 text-lg leading-relaxed">
                From clay that breathes, to lime that strengthens, from gypsum
                that insulates, to cow dung that heals, we work with ingredients
                that have long protected Indian homes—now reimagined for the
                world of tomorrow.
              </p>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative p-8 bg-gradient-to-br from-[#F8F6F0] to-[#F0EDE4] rounded-3xl border border-[#B8A94A] shadow-xl">
                ...
                <p className="text-2xl md:text-3xl text-[#2A2418]/80 font-light leading-relaxed mb-6">
                  We don't just create materials—we create movements. Movements
                  toward healthier homes, cleaner air, skilled local
                  communities, and a future where construction doesn't
                  compromise the planet.
                </p>
                <div className="flex items-center justify-center gap-4">
                  <Compass className="w-8 h-8 text-[#5E4E06]" />
                  <span className="text-[#5E4E06] font-semibold text-lg">
      ...
      <section className="py-24 bg-gradient-to-br from-[#F0EDE4] via-[#F8F6F0] to-[#E8E4D8] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-black text-[#5E4E06] mb-8">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-16">
                ...
                <div className="relative z-10">
                  <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 mb-10">
                    ...
                    <div className="text-center sm:text-left">
                      <h3 className="text-4xl font-black text-[#2A2418] mb-3">
                        Aura
                      </h3>
                      <p className="text-[#5E4E06] font-bold text-xl">
                        Natural Wall Plaster
                      </p>
                      <p className="text-[#2A2418]/60 text-lg mt-2">
                        Breathable • Toxin-Free • Beautiful
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="text-[#2A2418]/70 text-base sm:text-lg md:text-xl mb-10 leading-relaxed font-light">
                    AURA redefines wall finishes with a pioneering blend of
                    gypsum, cow dung, and natural minerals. More than a plaster,
                    it is a living surface that breathes, balances air quality,
                    and elevates interiors with timeless Indian knowledge
                    crafted for contemporary design. .
                  </p>
                  ...
                  <div className="grid grid-cols-1 gap-4 mb-10">
                    <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-6 bg-gradient-to-br from-[#F8F6F0] to-[#F0EDE4] rounded-2xl border border-[#B8A94A] hover:shadow-lg transition-all duration-300 group/feature hover:scale-105">
                      ...
                      <div className="min-w-0 flex-1">
                        <h4 className="text-[#2A2418] font-bold text-sm sm:text-base md:text-lg">
                          100% Natural Ingredients
                        </h4>
                        <p className="text-[#2A2418]/60 text-xs sm:text-sm">
                          Pure gypsum and organic cow dung
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-6 bg-gradient-to-br from-[#F8F6F0] to-[#F0EDE4] rounded-2xl border border-[#B8A94A] hover:shadow-lg transition-all duration-300 group/feature hover:scale-105">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[#2A2418]/60 text-xs sm:text-sm">
                          Naturally regulates indoor air quality
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-6 bg-gradient-to-br from-[#F8F6F0] to-[#F0EDE4] rounded-2xl border border-[#B8A94A] hover:shadow-lg transition-all duration-300 group/feature hover:scale-105">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[#2A2418]/60 text-xs sm:text-sm">
                          Crafted for Wellness: VOC-Free, Safe, Sustainable.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <Link
                    href="/aura"
                    className="block w-full py-4 sm:py-5 bg-gradient-to-r from-[#5E4E06] via-[#8B7A1A] to-[#5E4E06] text-white font-bold rounded-xl hover:shadow-lg transition-all duration-300 text-center text-lg sm:text-xl relative overflow-hidden group/btn"
                  >
            ...
            <div className="group relative w-full max-w-xl mx-auto lg:mx-0">
              ...
              <div className="relative bg-gradient-to-br from-[#F8F6F0] to-[#F0EDE4] rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl hover:shadow-3xl transition-all duration-500 border border-[#E8E4D8] overflow-hidden backdrop-blur-sm">
                <div
                  className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#5E4E06]/10 to-[#8B7A1A]/10 rounded-full -translate-y-16 translate-x-16 animate-pulse"
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#2A2418]/70 text-base sm:text-lg md:text-xl mb-10 leading-relaxed font-light">
                    Premium incense crafted from Himalayan herbs, desi cow dung,
                    and pure ghee, based on traditional Vedic practices for
                    purification and peaceful ambiance.
                  </p>
                  ...
                  <div className="grid grid-cols-1 gap-4 mb-10">
                    <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-6 bg-gradient-to-br from-[#F8F6F0] to-[#F0EDE4] rounded-2xl border border-[#B8A94A] hover:shadow-lg transition-all duration-300 group/feature hover:scale-105">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[#2A2418]/60 text-xs sm:text-sm">
                          Pure herbs from pristine mountains
                        </p>
                      </div>
                    </div>
      ...
      <section
        id="story"
        className="py-24 bg-gradient-to-br from-[#F8F6F0] via-[#F0EDE4] to-[#E8E4D8] relative overflow-hidden"
      >
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-5">
          <div
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-5xl md:text-6xl font-black text-[#5E4E06] mb-10">
                From Desert to Mountains
              </h2>

              <div className="space-y-8 mb-12">
                <p className="text-2xl text-[#2A2418]/70 leading-relaxed font-light">
                  From Desert to Mountains arises a journey inspired by India’s
                  vast landscapes, where timeless traditions reveal the art of
                  turning natural elements into enduring
                  <span className="font-semibold text-[#5E4E06]">
                    {" "}
                    wellness solutions.
                  </span>{" "}
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-4 px-12 py-6 bg-gradient-to-r from-[#5E4E06] via-[#8B7A1A] to-[#5E4E06] text-white font-bold rounded-full hover:shadow-lg transition-all duration-300 hover:scale-105 relative overflow-hidden group"
              >
      ...
      <section className="py-24 bg-gradient-to-br from-[#2A2418] via-[#5E4E06] to-[#8B7A1A] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-black text-white mb-10 leading-tight tracking-tight">
            <span className="inline-block">Ready for</span>{" "}
          ...
          <p className="text-2xl text-[#F5F2E8] mb-16 max-w-4xl mx-auto leading-relaxed font-light">
            Join our growing family of conscious homeowners who've chosen the
            path of wellness and sustainability.
          </p>

          <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center">
            <Link
              href="/contact"
              className="group px-8 sm:px-12 py-4 sm:py-6 bg-gradient-to-r from-[#5E4E06] via-[#8B7A1A] to-[#5E4E06] text-white font-bold rounded-full shadow-2xl hover:shadow-[#5E4E06]/25 transition-all duration-500 hover:scale-105 relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
            ...
            <Link
              href="/gallery"
              className="px-8 sm:px-12 py-4 sm:py-6 border-2 border-white/30 text-white font-bold rounded-full hover:bg-white hover:text-[#2A2418] transition-all duration-300 hover:scale-105"
            >
