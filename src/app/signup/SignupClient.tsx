...
export default function SignupClient() {
  ...
  const handlePhoneSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('pendingSignup', JSON.stringify({
        firstName: formData.firstName,
        lastName: formData.lastName,
        phone: formattedPhone, // This is now the formatted phone number
        method: 'phone'
      }));
    } catch (error) {
      const errorMessage = (error as Error).message;
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F5F2E8] to-[#E8E0C8]">
        ...
        <div className="flex items-center justify-center min-h-screen px-4">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-[#5E4E06] mb-4">Account Created Successfully!</h2>
            <p className="text-[#8B7A1A] mb-6">
              Welcome to our community! You can now start shopping and enjoy exclusive member benefits.
            </p>
            <Link
              href="/dashboard"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5F2E8] to-[#E8E0C8]">
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-[#5E4E06] mb-2">Create Your Account</h1>
              <p className="text-[#8B7A1A] text-sm sm:text-base">
                Join our community and start your journey with exclusive benefits
              </p>
            </div>
            ...
            {signupMethod === 'phone' && phoneVerificationSent ? (
              ...
              <form onSubmit={signupMethod === 'email' ? handleEmailSignup : handlePhoneSignup} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[#5E4E06] mb-2">First Name</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#5E4E06] mb-2">Last Name</label>
                    <div className="relative">
                      <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
                      <input
                        type="text"
                  ...
                  <div>
                    ...
                    <div className="flex">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-r-xl focus:border-[#D4B37] focus:outline-none transition-colors"
                ...
                {signupMethod === 'email' && (
                  <>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-[#5E4E06] mb-2">Confirm Password</label>
                      <div className="relative">
                        <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
                        <input
      ...
      {/* reCAPTCHA container for phone signup */}
      <div 
